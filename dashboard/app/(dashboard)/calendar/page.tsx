...
//     } catch {
//       console.error(
//         "Edit API returned invalid JSON:",
//         text
//       );
//     }
//   }
...
//   // The API should return the updated task.
//   const editedTask = data as {
//     id: string;
//     title: string;
//     dueDate: string | null;
//     description?: string;
...
//     id: editedTask.id,
//     emailId: action.emailId ?? undefined,
//     title: editedTask.title,
//     patientName: editedTask.patient
//       ? `${editedTask.patient.firstName} ${editedTask.patient.lastName}`
//       : updates.patientName,
...
//     googleEventId:
//       editedTask.googleEventId,
//     email: editedTask.email,
//     reminders: editedTask.reminders,
//   };

//   // Add the edited task to the calendar.
//   setDbEvents((prev) => [
//     ...prev.filter(
